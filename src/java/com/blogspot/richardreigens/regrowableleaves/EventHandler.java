        ...
        if (block.isLeaves(state, world, pos)) {
            ...
            if (player.getHeldItemMainhand() == null || player.getHeldItemMainhand().getItem() != Items.SHEARS) {
                ...
                if (block == Blocks.LEAVES) {
                    ...
                    if (ConfigurationHandler.debugMode) LogHelper.info("Minecraft leaves 2");
                    block.harvestBlock(world, player, pos, state, null, ItemStack.EMPTY);
                ...
                if (regrowableleaves.isBOPInstalled) {
                    if (block == Block.getBlockFromName("biomesoplenty:leaves_0")) {
                        if (ConfigurationHandler.debugMode) LogHelper.info("BOP leaves_0");
                        block.harvestBlock(world, player, pos, state, null, ItemStack.EMPTY);
                        ...
                        if (ConfigurationHandler.debugMode) LogHelper.info("BOP leaves_1");
                        block.harvestBlock(world, player, pos, state, null, ItemStack.EMPTY);
                        ...
                        if (ConfigurationHandler.debugMode) LogHelper.info("BOP leaves_2");
                        block.harvestBlock(world, player, pos, state, null, ItemStack.EMPTY);
                        ...
                        if (ConfigurationHandler.debugMode) LogHelper.info("BOP leaves_3");
                        block.harvestBlock(world, player, pos, state, null, ItemStack.EMPTY);
                        ...
                        if (ConfigurationHandler.debugMode) LogHelper.info("BOP leaves_4");
                        block.harvestBlock(world, player, pos, state, null, ItemStack.EMPTY);
                        ...
                        if (ConfigurationHandler.debugMode) LogHelper.info("BOP leaves_5");
                        block.harvestBlock(world, player, pos, state, null, ItemStack.EMPTY);
